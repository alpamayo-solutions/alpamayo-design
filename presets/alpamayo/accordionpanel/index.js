        ...
        class: [
            'flex flex-col border-b border-surface-200 dark:border-surface-700',
            {
                '*:data-[pc-name=accordionheader]:select-none *:data-[pc-name=accordionheader]:pointer-events-none *:data-[pc-name=accordionheader]:cursor-default *:data-[pc-name=accordionheader]:opacity-60':
                    props?.disabled,
                '*:data-[pc-name=accordionheader]:text-surface-700 dark:*:data-[pc-name=accordionheader]:text-surface-100 *:data-[pc-name=accordionheader]:hover:text-surface-800 dark:*:data-[pc-name=accordionheader]:hover:text-surface-0':
                    !props.disabled && context.active,
                '*:data-[pc-section=toggleicon]:text-surface-700 dark:*:data-[pc-section=toggleicon]:text-surface-100 *:data-[pc-section=toggleicon]:hover:text-surface-800 dark:*:data-[pc-section=toggleicon]:hover:text-surface-0':
                    !props.disabled && context.active,
