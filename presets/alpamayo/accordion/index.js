export default {
    ...
    accordiontab: {
        ...
        headerIcon: ({ context }) => ({
            class: ['inline-block ml-2', { 'text-surface-900 dark:text-surface-300': context.active }]
        }),
        headerTitle: {
            class: 'leading-none'
        },
        ...
        transition: {
            ...
            leaveActiveClass:
                'overflow-hidden transition-[max-height] duration-450 ease-[cubic-bezier(0,1,0,1)]',
