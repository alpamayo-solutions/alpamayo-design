    ...
    option: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                ...
                // Selected option: use explicit primary tokens so the highlighted item
                // stays legible against the very-light primary-50 background (same
                // contrast pattern as the sorted DataTable header).
            ...
            {
                'hover:bg-primary-100 dark:hover:bg-primary-900/60': context.selected
            },
            {
